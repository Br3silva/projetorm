        ...
        <div class="container mt-4" id="info-container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="info-window">
                        <h3>Medição</h3>
                        <p>temperatura:    <?php echo getLatestValue('dados_esp32', 'temperatura'); ?></p>

                        <!-- botao de configuração -->
                        <button  id="configAlarme" data-valor="temperatura" data-url="dashboard_adm_sensores_alarme.php" type="button" >
